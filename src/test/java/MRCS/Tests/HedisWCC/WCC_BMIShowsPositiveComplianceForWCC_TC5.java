...
public class WCC_BMIShowsPositiveComplianceForWCC_TC5 extends TestBase {
    ...
    @Test(description = "Verify that BMI shows positive compliance when all dates are in range", groups = {"Hedis WCC"})
    public void BMIShowsPositiveComplianceForWCC_TC5() throws Exception {
