...
public class WCC_VerifyContraOfNonCompliance_TC11 extends TestBase {
    ...
    @Test(description = "Contra non compliance shows only when exclusion date is in 2019 and page number is available", groups = {"Hedis WCC"})
    public void WCC_VerifyContraOfNonCompliance_TC11() throws Exception {
...
//        }
        ...
        sleep(2000);
        $x("//label[contains(text(),'Contra')]//following::button[@class='control__delete']").click();
        sleep(2000);
        $x("//label[contains(text(),'Contra')]//following::span[@class='ui-dropdown-trigger-icon ui-clickable pi pi-chevron-down']").click();
        sleep(2000);
        $x("//span[contains(text(),'Dx of pregnancy in')]").click();
        sleep(2000);
        $x("(//label[contains(text(),'Contra')]//following::input)[2]").setValue(Date1);
        sleep(2000);
        ...
        sleep(2000);
        if(Compliance.equals("NC/C")|| Compliance.equals("NC")) {
