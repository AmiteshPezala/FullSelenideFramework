...
public class RetrievalPSRAfterApprovalPenGetClosed_TC27 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    RetrievalPSR objRetrievalPSR = new RetrievalPSR();

    @Test(description = "Verify that after chase approved the pend associated with chase moved get closed.", groups = {"Retrieval PSR"})
    public void RetrievalPSRAfterApprovalPenGetClosed_TC27() throws Exception {
        ...
        sleep(2000);
        objRetrievalPSR.PendAssociatedToChaseClosed();
        objLoginOut.logout();
    }
