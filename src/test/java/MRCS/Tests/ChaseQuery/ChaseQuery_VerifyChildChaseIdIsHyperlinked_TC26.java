...
public class ChaseQuery_VerifyChildChaseIdIsHyperlinked_TC26 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Projects objProject = new Projects();
    WaitTool objWait = new WaitTool();
    ChaseQuery objChaseQuery=new ChaseQuery();

    @Test(description = "Verify that children chase id is hyperlinked and redirect to chase detail page .", groups = {"Chase Query"})
    public void ChaseQuery_VerifyChildChaseIdIsHyperlinked_TC26() throws Exception {
        ...
        if ($(CommonRepo.FirstChaseId).isDisplayed()) {
            ...
            if ($x("//app-chase-grid-chase-id//div[@class='chase-id__related-chases-container ng-star-inserted']").isDisplayed()) {
                ...
                if($x("//div[@class='chase-id__related-chases-container ng-star-inserted']//div[2]").isDisplayed()){
                    ...
                    logTestStep("Clicked on child chase link.");
                    objChaseQuery.VerifyChaseDetailPage();
