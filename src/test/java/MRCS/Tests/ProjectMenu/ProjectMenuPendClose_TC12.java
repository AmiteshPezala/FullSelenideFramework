...
public class ProjectMenuPendClose_TC12 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Projects objProject = new Projects();


    @Test(description = "Pend close functionality", groups = {"Project Menu"})
    public void ProjectMenuPendClose_TC12() throws Exception {
        ...
        if (($x("//tr[1]//td[2]")).exists()) {
            ...
            if (FirstPendCodeStatus.equals(NewPendCodeStatus1) ) {
                ...
                //logTestStep("First Pend code status changed sucessfully to resolve state ");
            }else{
                logTestStepPass("Pend code status changed successfully to closed state ");
                //Assert.fail("No records available");
            }
