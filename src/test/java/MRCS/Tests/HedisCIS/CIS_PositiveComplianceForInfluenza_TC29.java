...
public class CIS_PositiveComplianceForInfluenza_TC29 extends TestBase {
    ...
    @Test(description = "Influenza shows +ve compliance.", groups = {"Hedis CIS"})
    public void CIS_PositiveComplianceForInfluenza_TC29() throws Exception {
