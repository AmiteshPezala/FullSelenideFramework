...
public class CIS_NegativeComplianceForDtap_TC3 extends TestBase {
    ...
    @Test(description = "Verify that for DtAP compliance date is not before 42 days of age count.", groups = {"Hedis CIS"})
    public void CIS_NegativeComplianceForDtap_TC3() throws Exception {
        ...
        sleep(2000);
        objMeasure.NegativeComplianceDtap_CIS();
        sleep(2000);
        objLoginOut.logout();
    }
}
