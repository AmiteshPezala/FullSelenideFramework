...
public class Dob_VerifyMemberFirstName_TC6 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk= new Risk();

    @Test( description = "Verify member first name field", groups = {"IVA DOB"} )
    public void IVA_VerifyMemberFirstName() throws Exception {
