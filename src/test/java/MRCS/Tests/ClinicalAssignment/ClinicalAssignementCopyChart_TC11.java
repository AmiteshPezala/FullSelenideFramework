...
public class ClinicalAssignementCopyChart_TC11 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Clinical objClinical = new Clinical();


    @Test(description = "Verify copy chart", groups = {"Clinical Assignment"})
    public void ClinicalAssignementCopyChart_TC11() throws Exception {
