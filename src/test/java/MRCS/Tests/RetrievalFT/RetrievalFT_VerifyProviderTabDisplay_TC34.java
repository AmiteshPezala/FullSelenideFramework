...
public class RetrievalFT_VerifyProviderTabDisplay_TC34 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Retrieval objRetrieval = new Retrieval();

    @Test(description = "Verify provider tab display", groups = {"Retrieval FT"})
    public void RetrievalFT_VerifyProviderTabDisplay() throws Exception {
