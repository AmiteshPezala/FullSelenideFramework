...
public class RetrievalFT_VerifyAddressTimeLine_TC46 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Retrieval objRetrieval = new Retrieval();

    @Test(description = "Verify Address timeline option", groups = {"Retrieval FT"})
    public void VerifyAddressTimeLine() throws Exception {
