...
public class RetrievalFTEditAccessInfo_TC25 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Retrieval objRetrieval = new Retrieval();
    ReveleerTestData objRev=new ReveleerTestData();

    @Test(description = "Verify User can edit access info", groups = {"Retrieval FT"})
    public void RetrievalFTEditAccessInfo() throws Exception {
