...
public class RetrievalFTUploadAccessInfo_TC26 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Retrieval objRetrieval = new Retrieval();
    ReveleerTestData objRev=new ReveleerTestData();

    @Test(description = "Verify upload access info", groups = {"Retrieval FT"})
    public void RetrievalFTUploadAccessInfo() throws Exception {
