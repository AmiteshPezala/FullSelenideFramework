...
public class VerifyHCCFormFromOR2_TC7 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();
    Clinical objclinical = new Clinical();

    @Test(description = "HCC form get submitted successfully from OR2 ", groups = {"Submission"})
    public void VerifyHCCFormFromOR2_TC7() throws Exception {
        logTestStep("Log in to application");
        objLoginOut.loginAs(LoginOut.Actor.USERNAME_USERS);
        Common.PopUp();
        //objWait.implicitwait();
        sleep(2000);
        objRisk.getUserfromOR2();
        sleep(2000);
