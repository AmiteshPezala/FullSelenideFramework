...
public class ThirdPartyVendorNET30Filter_TC49 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();

    @Test(description = "Verify click on NET30 button filter with type NET30",groups = {"Invoices"})
    public void ThirdPartyVendorNET30Filter() throws Exception {
        ...
        sleep(2000);
        $x("//*[@id='InvoiceTypeIdsAsCsv']/div/div[2]/ul/li[1]").click();
        sleep(2000);
