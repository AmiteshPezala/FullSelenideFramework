...
public class Invoices_VerifyPagination_TC56 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();

    @Test(description = "Verify Pagination on invoices > invoices tab",groups = {"Invoices"})
    public void Invoices_VerifyPagination() throws Exception {
