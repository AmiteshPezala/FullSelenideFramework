...
public class ThirdPartyVendorFilterOption_TC46 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();

    @Test(description = "Verify filter option on invoice > 3 rd party Vendor tab",groups = {"Invoices"})
    public void ThirdPartyVendorFilterOption() throws Exception {
