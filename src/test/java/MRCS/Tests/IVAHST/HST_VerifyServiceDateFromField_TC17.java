...
public class HST_VerifyServiceDateFromField_TC17 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk = new Risk();

    @Test(description = "Verify that validation message is displayed or not.", groups = {"IVA HST"})
    public void HST_VerifyServiceDateFromField_TC17() throws Exception {
        ...
        sleep(2000);
        String EndDate=$x("(//div[contains(text(),'Service End Date')]//following::input)[2]").getValue();
