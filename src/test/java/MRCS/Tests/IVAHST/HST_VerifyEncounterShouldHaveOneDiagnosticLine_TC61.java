...
public class HST_VerifyEncounterShouldHaveOneDiagnosticLine_TC61 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk = new Risk();

    @Test(description = "Validation message should be displayed for diagnostic line validations.", groups = {"IVA HST"})
    public void HST_VerifyEncounterShouldHaveOneDiagnosticLine_TC61() throws Exception {
