...
public class HST_VerifyPageNoRequiredForServiceStartDate_TC44 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk = new Risk();

    @Test(description = "Verify that page no of service start date is a required field", groups = {"IVA HST"})
    public void HST_VerifyPageNoRequiredForServiceStartDate_TC44() throws Exception {
