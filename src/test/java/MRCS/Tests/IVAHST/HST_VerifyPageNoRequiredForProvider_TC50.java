...
public class HST_VerifyPageNoRequiredForProvider_TC50 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk = new Risk();

    @Test(description = "Verify that message is displayed if page no is not entered in provider field.", groups = {"IVA HST"})
    public void HST_VerifyPageNoRequiredForProvider_TC50() throws Exception {
