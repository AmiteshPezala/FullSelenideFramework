...
public class HST_VerifyPageNoRequiredForSignatureCredential_TC55 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk = new Risk();

    @Test(description = "Verify that message is displayed if page no not present for signature credential field.", groups = {"IVA HST"})
    public void HST_VerifyPageNoRequiredForSignatureCredential_TC55() throws Exception {
