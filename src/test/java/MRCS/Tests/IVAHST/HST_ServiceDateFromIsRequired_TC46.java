...
public class HST_ServiceDateFromIsRequired_TC46 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk = new Risk();

    @Test(description = "Verify that service date from is a required field.", groups = {"IVA HST"})
    public void HST_ServiceDateFromIsRequired_TC46() throws Exception {
