...
public class HST_VerifyEncounterDetailsAreDisabled_TC10 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk= new Risk();

    @Test( description = "Verify Encounter details are disabled when Specific service date = No and  F2F =No", groups = {"IVA HST"} )
