...
public class HST_NoteFieldRequiredForServiceStartDate_TC48 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    Risk objRisk = new Risk();

    @Test(description = "Verify that note field of service date from is a required field.", groups = {"IVA HST"})
    public void HST_NoteFieldRequiredForServiceStartDate_TC48() throws Exception {
