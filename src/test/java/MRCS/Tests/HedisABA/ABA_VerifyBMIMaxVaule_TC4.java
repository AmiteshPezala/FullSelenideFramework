...
public class ABA_VerifyBMIMaxVaule_TC4 extends TestBase {
    ...
    @Test(description = "Verify that message is displayed if we entered BMI value more than 100.", groups = {"Hedis ABA"})
    public void ABA_VerifyBMIMaxVaule_TC4() throws Exception {
        ...
        sleep(2000);
        logTestStep("verify the limit of value field of BMI module. ");
        $x("//div[contains(text(),'BMI')]//following::button[@class='control__delete ng-star-inserted']").click();
        sleep(2000);
        $x("(//div[contains(text(),'BMI')]//following::input)[2]").setValue("101");
        sleep(2000);
