...
public class ABA_VerifyContraField_TC20 extends TestBase {
    ...
    @Test(description = "Contra non compliance shows only when exclusion date is in 2019 and page number is available.", groups = {"Hedis ABA"})
    public void ABA_VerifyContraField_TC20() throws Exception {
        ...
        sleep(2000);
        $x("(//label[contains(text(),'Contra')]//following::input)[2]").setValue(newDate2);
        sleep(2000);
