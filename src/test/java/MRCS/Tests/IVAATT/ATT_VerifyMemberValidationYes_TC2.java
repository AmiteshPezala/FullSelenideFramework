...
public class ATT_VerifyMemberValidationYes_TC2 extends TestBase {
    ...
    @Test(description = "User can select Yes option.  Rest of the form gets enable.", groups = {"IVA ATT"})
    public void ATT_VerifyMemberValidationYes_TC2() throws Exception {
