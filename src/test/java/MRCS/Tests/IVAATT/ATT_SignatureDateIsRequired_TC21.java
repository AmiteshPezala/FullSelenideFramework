...
public class ATT_SignatureDateIsRequired_TC21 extends TestBase {
    ...
    @Test(description = "Verify that signature date field is required.", groups = {"IVA ATT"})
    public void ATT_SignatureDateIsRequired_TC21() throws Exception {
