...
public class ATT_SignatureLastNameIsRequired_TC17 extends TestBase {
    ...
    @Test(description = "Verify that signature last name is required field.", groups = {"IVA ATT"})
    public void ATT_SignatureLastNameIsRequired_TC17() throws Exception {
