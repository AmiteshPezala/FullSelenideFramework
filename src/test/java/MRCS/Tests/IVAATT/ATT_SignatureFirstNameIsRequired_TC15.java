...
public class ATT_SignatureFirstNameIsRequired_TC15 extends TestBase {
    ...
    @Test(description = "Verify that signature first name is a required field", groups = {"IVA ATT"})
    public void ATT_SignatureFirstNameIsRequired_TC15() throws Exception {
