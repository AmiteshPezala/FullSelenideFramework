...
public class ATT_PageNoSignatureDateIsRequired_TC20 extends TestBase {
    ...
    @Test(description = "Verify that page number is a required field for signature date field.", groups = {"IVA ATT"})
    public void ATT_PageNoSignatureDateIsRequired_TC20() throws Exception {
        ...
        sleep(2000);
        if(WebDriverRunner.getWebDriver().getPageSource().contains("Acceptable Signature Date, PageNumber  must be provided")){
