...
public class RetrievalEMRDetailsEditAddress_TC4 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Retrieval objRetrieval = new Retrieval();

    @Test(description = "Verify EMR Details - Edit Address", groups = {"Retrieval EMR"})
    public void RetrievalEMREditAddress() throws Exception {
