...
public class RiskServiceEndDateIsRequired_TC7 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Verify that message is displayed if we not fill service end date", groups = {"RiskForm"})
    public void RiskServiceEndDateIsRequired_TC7() throws Exception {
