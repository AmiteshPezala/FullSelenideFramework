...
public class RiskFromDateLessThanToDate_TC22 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Validation message should be displayed if service start date is greater than service end date", groups = {"RiskForm"})
    public void RiskFromDateLessThanToDate_TC22() throws Exception {
