...
public class VerifyMembersGenderFoundInDocument_TC3 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Verify that member's  gender found  in document field is a required field", groups = {"RiskForm"})
    public void VerifyMemberGender() throws Exception {
