...
public class RiskNoteIsRequiredForProvider_TC12 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Validation message should be displayed if note not entered in provider field", groups = {"RiskForm"})
    public void RiskNoteIsRequiredForProvider_TC12() throws Exception {
