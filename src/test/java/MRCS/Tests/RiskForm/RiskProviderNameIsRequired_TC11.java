...
public class RiskProviderNameIsRequired_TC11 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Verify that message is displayed if provider name field keep blank", groups = {"RiskForm"})
    public void RiskProviderNameIsRequired_TC11() throws Exception {
