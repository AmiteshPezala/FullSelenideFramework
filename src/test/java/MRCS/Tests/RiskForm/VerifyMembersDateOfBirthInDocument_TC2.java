...
public class VerifyMembersDateOfBirthInDocument_TC2 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Verify that member's date of birth in document field is a required field", groups = {"RiskForm"})
    public void VerifyMemberDate() throws Exception {
