...
public class RiskSignatureDateFiledIsRequired_TC18 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Verify that message is displayed if date is not selected of signature field", groups = {"RiskForm"})
    public void RiskSignatureDateFiledIsRequired_TC18() throws Exception {
