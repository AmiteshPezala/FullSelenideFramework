...
public class RiskPageOfSignatureLastNameField_TC14 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Validation message should be displayed as page no is required.", groups = {"RiskForm"})
    public void RiskPageOfSignatureLastNameField_TC14() throws Exception {
