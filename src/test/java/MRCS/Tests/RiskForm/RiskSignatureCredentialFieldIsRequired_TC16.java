...
public class RiskSignatureCredentialFieldIsRequired_TC16 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Verify that message is displayed if signature credential field keep blank", groups = {"RiskForm"})
    public void RiskSignatureCredentialFieldIsRequired_TC16() throws Exception {
