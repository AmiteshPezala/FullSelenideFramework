...
public class RiskServiceDateOutsideProjectDate_TC23 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();


    @Test(description = "Verify that message is displayed if service date is outside project configuration date", groups = {"RiskForm"})
    public void RiskServiceDateOutsideProjectDate_TC23() throws Exception {
