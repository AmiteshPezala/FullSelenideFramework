...
public class RiskNoteRequiredForServiceEndDate_TC9 extends TestBase {
    LoginOut objLoginOut = new LoginOut();
    WaitTool objWait = new WaitTool();
    Risk objRisk = new Risk();

    @Test(description = "Validation message should be displayed if note is not entered in service end date field", groups = {"RiskForm"})
    public void RiskNoteRequiredForServiceEndDate_TC9() throws Exception {
