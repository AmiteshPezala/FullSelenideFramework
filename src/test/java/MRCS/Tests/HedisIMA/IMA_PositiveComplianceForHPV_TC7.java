...
public class IMA_PositiveComplianceForHPV_TC7 extends TestBase {
    ...
    @Test(description = "HPV shows +ve compliance when 2 HPV VACCINATIONS (146 DAYS APART)", groups = {"Hedis IMA"})
    public void PositiveComplianceForHPV_TC7() throws Exception {
