...
public class COL_VerifyColateralCancerScreeningShowsPositiveCompliance_TC12 extends TestBase {
...
//        System.out.println(CurrentDate);
        $x("(//div[contains(text(),'CT Colonography in')]//following::input)[1]").setValue("12/31/2018");
        sleep(2000);
        $x("(//div[contains(text(),'CT Colonography in')]//following::input)[3]").setValue("1");
        sleep(2000);
        $x("(//div[contains(text(),'CT Colonography in')]//following::button)[1]").click();
        sleep(2000);
        ...
        if(GetMsg.equals("C/MR")){
            ...
            Assert.fail("Colorectal Cancer Screening shows -ve compliance");
        }
        sleep(2000);
        objLoginOut.logout();
    }
