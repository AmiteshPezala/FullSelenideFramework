...
public class ENR_EnrollmentDateFromPageNoIsRequired_TC32 extends TestBase {
    ...
    @Test(description = "Verify page number is required for service date from field", groups = {"IVA ENR"})
    public void ENR_EnrollmentDateFromPageNoIsRequired_TC32() throws Exception {
