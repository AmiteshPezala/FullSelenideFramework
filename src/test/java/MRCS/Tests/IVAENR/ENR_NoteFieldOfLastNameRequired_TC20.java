...
public class ENR_NoteFieldOfLastNameRequired_TC20 extends TestBase {
    ...
    public void ENR_NoteFieldOfLastNameRequired_TC20() throws Exception {
        ...
        sleep(2000);
        String AdminVaule =$x("(//div[contains(text(),'Last Name')]//following::input)[3]").getValue();
        Log.info(AdminVaule);
        objMeasure.MemberId_ENR();
        objMeasure.FirstName_ENR();
        $x("(//div[contains(text(),'Last Name')]//following::button[@class='control__delete ng-star-inserted'])").click();
        sleep(2000);
        ...
        sleep(2000);
        $x("(//div[contains(text(),'Last Name')]//following::input)[2]").setValue(AdminVaule);
        sleep(2000);
