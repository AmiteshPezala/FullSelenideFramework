...
public class ENR_FirstNameFieldIsRequired_TC12 extends TestBase {
    ...
    @Test(description = "Verify that first name  is required field.", groups = {"IVA ENR"})
    public void ENR_FirstNameFieldIsRequired_TC12() throws Exception {
