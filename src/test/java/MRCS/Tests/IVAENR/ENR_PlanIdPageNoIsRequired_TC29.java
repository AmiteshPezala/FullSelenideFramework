...
public class ENR_PlanIdPageNoIsRequired_TC29 extends TestBase {
    ...
    @Test(description = "Verify page number is required for plan ID.", groups = {"IVA ENR"})
    public void ENR_PlanIdPageNoIsRequired_TC29() throws Exception {
