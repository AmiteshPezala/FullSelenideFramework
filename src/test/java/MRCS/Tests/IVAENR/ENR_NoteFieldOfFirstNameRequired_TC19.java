...
public class ENR_NoteFieldOfFirstNameRequired_TC19 extends TestBase {
    ...
    public void ENR_NoteFieldOfFirstNameRequired_TC19() throws Exception {
        ...
        String AdminVaule =$x("(//div[contains(text(),'First Name')]//following::input)[3]").getValue();
        Log.info(AdminVaule);
        ...
        sleep(2000);
        $x("(//div[contains(text(),'First Name')]//following::input)[2]").setValue(AdminVaule);
        sleep(2000);
