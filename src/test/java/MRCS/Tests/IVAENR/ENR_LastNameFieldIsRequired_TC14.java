...
public class ENR_LastNameFieldIsRequired_TC14 extends TestBase {
    ...
    @Test(description = "Verify that last name  is required field.", groups = {"IVA ENR"})
    public void ENR_LastNameFieldIsRequired_TC14() throws Exception {
