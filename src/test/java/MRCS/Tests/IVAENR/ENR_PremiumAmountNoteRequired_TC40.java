...
public class ENR_PremiumAmountNoteRequired_TC40 extends TestBase {
    ...
    public void ENR_PremiumAmountNoteRequired_TC40() throws Exception {
        ...
        if(SubscriberType.contains("S")) {
            ...
            sleep(2000);
            String AdminVaule =$x("(//div[contains(text(),'Premium Amount')]//following::input)[3]").getValue();
            Log.info(AdminVaule);
            ...
            sleep(2000);
            $x("(//div[contains(text(),'Premium Amount')]//following::input)[1]").setValue("1");
            sleep(2000);
            $x("(//div[contains(text(),'Premium Amount')]//following::input)[2]").setValue(AdminVaule);
            sleep(2000);
