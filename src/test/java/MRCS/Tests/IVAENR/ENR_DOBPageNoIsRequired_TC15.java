...
public class ENR_DOBPageNoIsRequired_TC15 extends TestBase {
    ...
    @Test(description = "Verify that page no of DOB is required field.", groups = {"IVA ENR"})
    public void ENR_DOBPageNoIsRequired_TC15() throws Exception {
        ...
        $x("((//div[contains(text(),'DOB')])[2]//following::button[@class='control__delete ng-star-inserted'])").click();
        sleep(2000);
