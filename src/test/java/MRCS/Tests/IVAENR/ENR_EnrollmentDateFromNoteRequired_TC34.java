...
public class ENR_EnrollmentDateFromNoteRequired_TC34 extends TestBase {
    ...
    public void ENR_EnrollmentDateFromNoteRequired_TC34() throws Exception {
        ...
        sleep(2000);
        String AdminVaule =$x("(//div[contains(text(),'Enrollment From Date')]//following::input)[3]").getValue();
        Log.info(AdminVaule);
        ...
        sleep(2000);
        $x("(//div[contains(text(),'Enrollment From Date')]//following::input)[2]").setValue(AdminVaule);
        sleep(2000);
        ...
        sleep(2000);
        if (WebDriverRunner.getWebDriver().getPageSource().contains("EnrollmentStartDate, PageNumber, Confirm  must be provided")) {
