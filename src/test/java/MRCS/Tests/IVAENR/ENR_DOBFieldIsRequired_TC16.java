...
public class ENR_DOBFieldIsRequired_TC16 extends TestBase {
    ...
    @Test(description = "Verify that DOB is required field.", groups = {"IVA ENR"})
    public void ENR_DOBFieldIsRequired_TC16() throws Exception {
