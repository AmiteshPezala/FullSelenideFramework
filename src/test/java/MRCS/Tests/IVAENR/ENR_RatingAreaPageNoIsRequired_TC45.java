...
public class ENR_RatingAreaPageNoIsRequired_TC45 extends TestBase {
    ...
    @Test(description = "Verify that page no of rating area is required field.", groups = {"IVA ENR"})
    public void ENR_RatingAreaPageNoIsRequired_TC45() throws Exception {
       ...
       String SubscriberType=$x("//input[@id='SubscriberType']").getValue();
        ...
        if(SubscriberType.equals("S")){
            ...
            sleep(2000);
            $x("//div[contains(text(),'Rating Area')]//following::span[contains(text(),'Yes')]").click();
            sleep(2000);
