...
public class ART_VerifyPositiveComplianceSubmitted_TC7 extends TestBase {
    ...
    @Test(description = "Verify chase can be submitted when the complaince is +ve", groups = {"Hedis ART"})
